...
class Application(tk.Frame):
 ...
 retailer_label = tk.Entry(self.master, font=('bold', 12))
 # Price
 ...
 self.price_label = tk.Entry(self.master,font=('bold', 12))
 ...
 # Delete items before update. So when you keep pressing it doesnt keep getting (show
example by calling this twice)
 ...
 # Add new item
 def add_item(self):
 if self.part_text.get() == '' or self.customer_text.get() == '' or self.retailer_text.get() == ''
